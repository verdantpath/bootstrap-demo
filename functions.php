...
function theme_js() {
  ...
  wp_register_script( 'html5_shiv', 'https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.min.js', '', '', false );
  wp_register_script( 'html5_shiv', 'https://cdnjs.cloudflare.com/ajax/libs/respond.js/1.4.2/respond.min.js', '', '', false );
